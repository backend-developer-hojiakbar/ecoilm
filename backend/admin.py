...
class BooksAdmin(admin.ModelAdmin):
    list_display = ["nomi", "pdf", "jpg"]
@admin.register(models.Xamkorlar)
class XamkorlarAdmin(admin.ModelAdmin):
    list_display = ["nomi", "info", "img"]

@admin.register(models.Moddalar)
class ModdalarAdmin(admin.ModelAdmin):
    list_display = ["moddaSoni", "date", "about", "link"]
