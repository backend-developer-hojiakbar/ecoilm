...
def moddalar(request):
    moddalar = Moddalar.objects.all()

    context = {
        "moddalar": moddalar,
    }
    return render(request, 'moddalar.html', context)
...
def secondProjectsList(request):
    ...
    return render(request, 'events-list2.html', context)
...
def labar(request):
    ...
    return render(request, "laboratoriya_va_bolimlar.html", context)
    
def tuzilma(request):
    context = {
        "footerNews": NewsUrl.objects.all().order_by("created_at")[:4]
    }
    return render(request, "tuzilma.html", context)
    
def rahbariyat_list(request):
    context = {
        "footerNews": NewsUrl.objects.all().order_by("created_at")[:4]
    }
...
def qonunlarList(request):
    context = {
        "footerNews": NewsUrl.objects.all().order_by("created_at")[:4]
    }
    return render(request, "qonunlar.html", context)
    
def vazifa_funksiyalar(request):
    context = {
        "footerNews": NewsUrl.objects.all().order_by("created_at")[:4]
    }
    return render(request, "vazifa_funk.html", context)

def send_article(request):
    context = {
        "footerNews": NewsUrl.objects.all().order_by("created_at")[:4]
    }
    return render(request, "sendArticle.html", context)

def ilmiyKengash(request):
    context = {
        "footerNews": NewsUrl.objects.all().order_by("created_at")[:4]
    }
    return render(request, "ilmiy_kengash.html", context)
    
    
def patentlar(request):
    patentlar = Patent.objects.all()

    context = {
        "patentlar": patentlar,
    }
    return render(request, 'patentlar.html', context)
def books(request):
...
def xamkor(request):
    xamkor = Xamkorlar.objects.all()

    context = {
        "xamkor": xamkor,
    }
    return render(request, "xamkor.html", context)